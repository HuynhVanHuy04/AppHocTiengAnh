...
public class DatabaseHealth3 extends SQLiteOpenHelper {
    ...
    public DatabaseHealth3(Context context) {
    ...
    public String[] getRandomWord() {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM health2 ORDER BY RANDOM() LIMIT 1", null);
