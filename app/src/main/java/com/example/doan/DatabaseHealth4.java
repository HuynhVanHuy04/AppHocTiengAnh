...
public class DatabaseHealth4 extends SQLiteOpenHelper {
    private static final String DB_NAME = "health.db";
    private static String DB_PATH = "";
    private Context context;

    public DatabaseHealth4(Context context) {
    ...
    public List<Word> getRandomWords(int limit) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM Health_list ORDER BY RANDOM() LIMIT ?", new String[]{String.valueOf(limit)});
