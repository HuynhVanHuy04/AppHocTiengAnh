...
public class DatabaseFamilylist4 extends SQLiteOpenHelper {
    private static final String DB_NAME = "english_list.db";
    private static String DB_PATH = "";
    private Context context;

    public DatabaseFamilylist4(Context context) {
    ...
    public List<Word> getRandomWords(int limit) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM List_Family ORDER BY RANDOM() LIMIT ?", new String[]{String.valueOf(limit)});
