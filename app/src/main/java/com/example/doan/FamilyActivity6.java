...
public class FamilyActivity6 extends AppCompatActivity {
    ...
    String expectedSentence = "Father."; // Câu mẫu người dùng cần phát âm

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_family6); // Giao diện layout XML
        ...
        backArrow.setOnClickListener(v -> {
            Intent intent = new Intent(FamilyActivity6.this, FamilyActivity5.class);
