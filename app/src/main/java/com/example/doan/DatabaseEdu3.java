...
public class DatabaseEdu3 extends SQLiteOpenHelper {
    ...
    public DatabaseEdu3(Context context) {
    ...
    public String[] getRandomWord() {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM eg_edu ORDER BY RANDOM() LIMIT 1", null);
