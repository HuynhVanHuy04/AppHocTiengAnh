...
public class DatabaseHealth1 extends SQLiteOpenHelper {
    ...
    public DatabaseHealth1(Context context) {
    ...
    public String[] getRandomWord() {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM health1 ORDER BY RANDOM() LIMIT 1", null);
