...
public class DatabaseFamily3 extends SQLiteOpenHelper {
    ...
    public DatabaseFamily3(Context context) {
    ...
    public String[] getRandomWord() {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM Family2 ORDER BY RANDOM() LIMIT 1", null);
