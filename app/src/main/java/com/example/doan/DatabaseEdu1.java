...
public class DatabaseEdu1 extends SQLiteOpenHelper {
    ...
    public DatabaseEdu1(Context context) {
    ...
    public String[] getRandomWord() {
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM english ORDER BY RANDOM() LIMIT 1", null);
            if (cursor != null && cursor.moveToFirst()) {
                word[0] = cursor.getString(cursor.getColumnIndexOrThrow("eg"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
