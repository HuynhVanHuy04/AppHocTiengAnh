/* prebid.js v9.39.0
Updated: 2025-04-11
Modules: paapi, fpdModule, rtdModule, userId, adagioBidAdapter, appnexusBidAdapter, criteoBidAdapter, ixBidAdapter, openxBidAdapter, pubmaticBidAdapter, rubiconBidAdapter, teadsBidAdapter, tripleliftBidAdapter, yandexBidAdapter, adagioRtdProvider, atsAnalyticsAdapter, consentManagementGpp, consentManagementTcf, consentManagementUsp, criteoIdSystem, gptPreAuction, identityLinkIdSystem, multibid, paapiForGpt, pairIdSystem, schain, sharedIdSystem, topicsFpdModule, unifiedIdSystem */
...
(self.pbjsChunk=self.pbjsChunk||[]).push([[7606],{7194:(n,t,e)=>{e.d(t,{$:()=>u});var s=e(7314);const u=()=>function(n){const t=new WeakMap;return function(e){let s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};const u=n(e);if(null!=u)return t.has(u)||t.set(u,s),t.get(u)}}((n=>s.n.index.getAuction({auctionId:n})))}}]);
